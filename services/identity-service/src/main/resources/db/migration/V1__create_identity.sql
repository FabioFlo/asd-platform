CREATE TYPE person_status_enum        AS ENUM ('ACTIVE', 'DECEASED', 'ANONYMISED');
CREATE TYPE qualification_status_enum AS ENUM ('VALID', 'EXPIRED', 'REVOKED');
...
CREATE TABLE qualification (
    ...
    data_scadenza       DATE,
    stato               qualification_status_enum NOT NULL DEFAULT 'VALID',
...
CREATE TRIGGER trg_qualification_updated_at
    BEFORE UPDATE ON qualification FOR EACH ROW EXECUTE FUNCTION set_updated_at();
