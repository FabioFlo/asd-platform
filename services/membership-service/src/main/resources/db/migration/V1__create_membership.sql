...
CREATE TRIGGER trg_role_assignment_updated_at
    BEFORE UPDATE ON role_assignment FOR EACH ROW EXECUTE FUNCTION set_updated_at();
...
CREATE TRIGGER trg_group_enrollment_updated_at
    BEFORE UPDATE ON group_enrollment FOR EACH ROW EXECUTE FUNCTION set_updated_at();
